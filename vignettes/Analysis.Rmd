...
```{r best.en.c.index, echo=FALSE, fig.asp=1}
...
```{r best.hub.c.index, echo=FALSE, fig.asp=1}
filter.model <- 'Hub'
best.model.print(filter.model, best.ones, xdata, ydata.month, ntimes.results)
```
...
```{r best.orphan.c.index, echo=FALSE, fig.asp=1}
filter.model <- 'Orphan'
best.model.print(filter.model, best.ones, xdata, ydata.month, ntimes.results)
```
...
```{r best.en.log.rank, echo=FALSE, fig.asp=1}
filter.model <- 'Elastic Net'
best.model.print(filter.model, best.ones, xdata, ydata.month, ntimes.results)
```
...
```{r best_hub.log.rank, echo=FALSE, fig.asp=1}
filter.model <- 'Hub'
best.model.print(filter.model, best.ones, xdata, ydata.month, ntimes.results)
```
...
```{r best_orphan.log.rank, echo=FALSE, fig.asp=1}
filter.model <- 'Orphan'
